          ...
          tasks: [
            {
              ...
              title: 'First task',
              status: 'cannot_start',
              link: '/applications/some-uuid/tasks/first-task/pages',
              linkHtml: 'First task',
            ...
            },
            {
              ...
              title: 'Second task',
              status: 'cannot_start',
              link: '/applications/some-uuid/tasks/second-task/pages',
              linkHtml: 'Second task',
          ...
          tasks: [
            {
              ...
              status: 'cannot_start',
              linkHtml: 'Third task',
              link: '/applications/some-uuid/tasks/third-task/pages',
            ...
            },
            {
              ...
              title: 'Fourth task',
              status: 'cannot_start',
              link: '/applications/some-uuid/tasks/fourth-task/pages',
              linkHtml: 'Fourth task',
            ...
            },
            {
              ...
              status: 'cannot_start',
              linkHtml: 'Fifth task',
              link: '/applications/some-uuid/tasks/fifth-task/pages',
