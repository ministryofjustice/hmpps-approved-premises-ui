...
export type { PremisesLocalRestriction } from './models/PremisesLocalRestriction';
export type { PremisesLocalRestrictionSummary } from './models/PremisesLocalRestrictionSummary';
