...
export const getKeyDetail = (person: Person, tier?: string): KeyDetailsArgs => ({
...
export const placementKeyDetails = (placement: Cas1SpaceBooking) => getKeyDetail(placement.person, placement.tier)
