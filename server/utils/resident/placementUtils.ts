...
const getUpcomingFields = (placement: Cas1SpaceBooking | Cas1SpaceBookingShortSummary): Array<SummaryListItem> => {
  return [
...
const getArrivedFields = (placement: Cas1SpaceBooking | Cas1SpaceBookingShortSummary): Array<SummaryListItem> => {
  return [
    summaryListItem('Approved Premises', placement.premises.name),
    summaryListItem('Date of booking', placement.createdAt, 'date'),
...
const getNotArrivedFields = (placement: Cas1SpaceBooking | Cas1SpaceBookingShortSummary): Array<SummaryListItem> => {
  return [
    summaryListItem('Approved Premises', placement.premises.name),
    summaryListItem('Date of booking', placement.createdAt, 'date'),
    summaryListItem('Expected arrival date', placement.expectedArrivalDate, 'date'),
...
const getDepartedFields = (placement: Cas1SpaceBooking | Cas1SpaceBookingShortSummary): Array<SummaryListItem> => {
  return [
    summaryListItem('Approved Premises', placement.premises.name),
    summaryListItem('Date of booking', placement.createdAt, 'date'),
...
const getCancelledFields = (placement: Cas1SpaceBooking | Cas1SpaceBookingShortSummary): Array<SummaryListItem> => {
  return [
    summaryListItem('Approved Premises', placement.premises.name),
    summaryListItem('Date of booking', placement.createdAt, 'date'),
    summaryListItem('Expected arrival date', placement.expectedArrivalDate, 'date'),
