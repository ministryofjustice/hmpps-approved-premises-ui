...
import { CallResult, sentenceCase } from '../utils'
...
export const offenceCards = (offences: Array<ActiveOffence>, offencesMeta: CallResult): Array<SummaryListWithCard> => {
  const title = 'Offence'
...
export const offencesTabCards = (
  ...
  [offencesResult]: Array<CallResult>,
): Array<SummaryListWithCard> => [...offenceCards(offences, offencesResult), ...oasysOffenceCards(oasysAnswers)]

export const licenseCards = (licence: Licence, licenceResult: CallResult): Array<SummaryListWithCard> => {
...
export const prisonCards = ({
  ...
  adjudicationResult: CallResult
  csraSummaries: Array<CsraSummary>
  csraResult: CallResult
  person: Person
  personResult: CallResult
