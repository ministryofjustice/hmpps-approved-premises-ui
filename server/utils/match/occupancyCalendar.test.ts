          ...
          days: [
            {
              ...
              status: 'overbooked',
              detailsUrl: 'foo/2025-02-02?criteria=hasEnSuite',
            },
          ],
        },
      ])
          ...
          days: [
            {
              ...
              detailsUrl: 'foo/2025-02-02?criteria=isSuitedForSexOffenders',
            },
          ],
        },
      ])
          ...
          days: [
            {
              ...
              criteriaBookableCount: 1,
              status: 'availableForCriteria',
              detailsUrl: 'foo/2025-02-02?criteria=isWheelchairDesignated',
            },
          ],
        },
      ])
          ...
          days: [
            {
              ...
              status: 'overbooked',
              detailsUrl: 'foo/2025-02-02?criteria=isStepFreeDesignated',
            },
          ],
        },
      ])
          ...
          days: [
            {
              ...
              status: 'overbooked',
              detailsUrl:
                'foo/2025-02-02?criteria=hasEnSuite&criteria=isSuitedForSexOffenders&criteria=isWheelchairDesignated',
            },
          ],
        },
      ])
