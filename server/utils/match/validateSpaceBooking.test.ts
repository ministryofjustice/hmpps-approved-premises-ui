...
describe('validateSpaceBooking', () => {
  ...
  describe('validation fails', () => {
    it.each([
      ...
      [
        'arrival date and deaprture date are same day',
        {
          'arrivalDate-day': '15',
          'arrivalDate-month': '5',
          'arrivalDate-year': '2025',
        ...
        {
          departureDate: 'The departure date and arrival date cannot be the same day',
        },
      ],
      [
        ...
        {
          departureDate: 'The departure date must not be before the arrival date',
        },
      ],
