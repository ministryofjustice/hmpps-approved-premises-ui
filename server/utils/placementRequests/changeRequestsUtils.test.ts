  ...
  describe('changeRequestsTableRows', () => {
    it('renders the table rows for the change requests table', () => {
      ...
      expect(changeRequestsTableRows(changeRequests)).toEqual([
        [
          {
            html: `<a href="${adminPaths.admin.placementRequests.show({ placementRequestId: changeRequests[0].placementRequestId })}">John Smith, C123456</a>`,
          },
          { html: tierBadge('B3') },
          { text: '6 May 2025' },
        ...
        [
          {
            html: `<a href="${adminPaths.admin.placementRequests.show({ placementRequestId: changeRequests[1].placementRequestId })}">Limited Access Offender, X987654</a>`,
          },
          { html: tierBadge('A1') },
          { text: '12 Jul 2025' },
        ...
        [
          {
            html: `<a href="${adminPaths.admin.placementRequests.show({ placementRequestId: changeRequests[2].placementRequestId })}">Unknown person, A333444</a>`,
          },
          { html: tierBadge('C1') },
          { text: '6 Jun 2025' },
