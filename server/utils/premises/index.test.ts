...
describe('premisesUtils', () => {
  ...
  describe('placementStatusHtml', () => {
    it('should render the status of the placement as html', () => {
      ...
      expect(placementStatusHtml({ ...placement, appealRequested: true })).toEqual({
        html: 'Upcoming<br/>Appeal requested',
      })
      expect(placementStatusHtml({ ...placement, appealRequested: true, plannedTransferRequested: true })).toEqual({
