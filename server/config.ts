...
export default {
  ...
  approvedPremisesRootPath: get('APPROVED_PREMISES_ROOT_PATH', 'approved-premises', requiredInProduction),
  temporaryAccommodationRootPath: get('TEMPORARY_ACCOMMODATION_ROOT_PATH', 'approved-premises', requiredInProduction),
}
