import { Cas1Application, Document } from '@approved-premises/api'
...
export default class AttachDocumentsPage extends ApplyPage {
  ...
  constructor(documents: Array<Document>, selectedDocuments: Array<Document>, application: Cas1Application) {
    super(
